    ...
    <>
      <div className="relative w-full overflow-hidden leading-none ">
        <svg
          ...
          className="relative block w-[calc(100%+1.3px)] h-[95px]"
        >
          <path
      ...
      <section
        id="Projects"
        className="scroll-mt-32 flex items-center justify-center flex-col pb-8 relative px-4 md:px-16 lg:px-20 "
      >
...
"
          ...
          <Card
            image={projectImage3}
            live={"https://tad-tic-tac-toe.netlify.app/"}
            github={"https://github.com/Tewodros-Tilahun-01/tic-tac-toe"}
            description={
              "Tic-Tac-Toe Game is a simple, interactive two-player game built with React. It provides an engaging way to enjoy the classic game directly in your web browser."
            }
